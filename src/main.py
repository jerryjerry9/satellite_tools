...
## prepare enviromnent
path = '/data/C.jerryjerry9/satellite_tools'
...
## Set band type
band = ['VIS','TIR']  # band: VIS TIR SIR EXT
...
file_list, zip_file_list, full_path_file_list = himawari.generated_list(year=year,mon=mon,day=day,hour=hour,minn=minn,band=band,band_num=band_num,geo=geo, band4km=band4km)

## method 2: download data within a time range
## Given time_period & time_delta will prioritize using method 2
#file_list, zip_file_list, full_path_file_list = himawari.generated_list(time_period=time_period,time_delta=time_delta,year=year,mon=mon,day=day,hour=hour,minn=minn,band=band,band_num=band_num,geo=geo, band4km=band4km)
